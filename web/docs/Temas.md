...
- **Pantalla de carga al arrancar**: nada más abrirse, la ventana muestra el logotipo e «Iniciando…» mientras la aplicación termina de arrancar, en lugar de un rectángulo vacío. Activada por defecto; desactivada, la ventana no aparece hasta que la interfaz está lista. «Reducir movimiento» deja quieta su barra de progreso.
