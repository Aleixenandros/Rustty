...
- Guardar contraseñas y passphrases en el **keyring del sistema** (KWallet, GNOME Keyring, Keychain, Credential Store) o tomarlas de una base **KeePass** (`.kdbx`), que puede **bloquearse sola** tras un rato sin usarla o al suspender el equipo.
