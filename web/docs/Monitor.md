...
- **Avisar al superar un umbral**: con el monitor encendido, muestra un aviso cuando la **CPU**, la **memoria** o un **disco** del servidor superan el porcentaje que elijas (cada métrica tiene su propio umbral, o «Sin alerta»). Cada métrica avisa **una vez por episodio**: no se repite mientras siga alta, y se rearma cuando baja. Funciona también con la sesión en segundo plano — para eso está.
