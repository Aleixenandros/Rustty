...
Nosotros, como miembros, colaboradores y administradores de Rustty, nos
...
eliminar, editar o rechazar comentarios, *commits*, código, ediciones de páginas
de wiki, *issues* y otras contribuciones que no se alineen con este Código de
...
públicos donde un individuo esté en representación del proyecto o su comunidad.
Ejemplos de esto incluyen el uso de una cuenta oficial de correo electrónico,
publicaciones a través de una cuenta oficial en redes sociales, o presentaciones
con personas designadas en eventos en línea o no.

## Aplicación

Instancias de comportamiento abusivo, acosador o inaceptable de otro modo pueden
ser reportadas a los administradores de la comunidad responsables de la
aplicación a través de **aleixenandros@gmail.com**. Todas las quejas serán
...
**Consecuencia**: Un aviso privado por escrito de los administradores de la
comunidad, proporcionando claridad alrededor de la naturaleza de este
incumplimiento y una explicación de por qué el comportamiento es inaceptable. Se
puede solicitar una disculpa pública.
...
se interactúa con las personas involucradas, incluyendo interacción no solicitada
con quienes se encargan de hacer cumplir el Código de conducta, durante un
...
especificado. Durante este periodo no se permite interactuar de manera pública o
privada con las personas involucradas, incluyendo interacciones no solicitadas
con quienes se encargan de hacer cumplir el Código de conducta. Incumplir estos
...
en el tiempo, acoso a individuos o agresiones o menosprecio a grupos de
individuos.
