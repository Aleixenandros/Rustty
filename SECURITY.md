...
Solo la última versión menor publicada recibe parches de seguridad. La versión actual es la línea **2.0.x** (`package.json` y `src-tauri/Cargo.toml` declaran `2.0.0`).
