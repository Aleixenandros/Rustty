...
Solo la última versión menor publicada recibe parches de seguridad. La versión actual es la línea **1.69.x** (`package.json` y `src-tauri/Cargo.toml` declaran `1.69.0`).
...
Si usas una versión anterior, actualiza a la última 1.69.x para recibir correcciones.
