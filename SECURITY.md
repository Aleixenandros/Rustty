...
Solo la última versión menor publicada recibe parches de seguridad. La versión actual es la línea **1.58.x** (`package.json` y `src-tauri/Cargo.toml` declaran `1.58.1`).
